...
public class AtlasClientV2 extends AtlasBaseClient {
    ...
    public AtlasRelationship getRelationshipByGuid(String guid) throws AtlasServiceException {
        return callAPI(API_V2.GET_RELATIONSHIP_BY_GUID, AtlasRelationship.class, (MultivaluedMap<String, String>) null, guid);
    }

    public void deleteRelationshipByGuid(String guid) throws AtlasServiceException {
        callAPI(API_V2.DELETE_RELATIONSHIP_BY_GUID, (Class) null, (MultivaluedMap<String, String>) null, guid);
    }
